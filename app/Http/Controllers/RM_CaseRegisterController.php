...
class RM_CaseRegisterController extends Controller
{
    ...
    } public function running_case()
    {
        ...
        $query =  RM_CaseRgister::where('status', 1)->orderby('id','DESC');
    ...
    public function create()
    {
        ...
        if($roleID == 24){
            ...
            $data['divisions'] = DB::table('division')
                ...
                ->get();
            $data['old_case_no'] = DB::table('r_m__case_rgisters')->select('id', 'case_no')->where('status',3)->get();
        }
        if($roleID == 22){
            ...
            $data['districts'] = DB::table('district')
                ...
                ->get();
            $data['old_case_no'] = DB::table('r_m__case_rgisters')->select('id', 'case_no')->where('status',3)->where('division_id',$userDivision)->get();
        }
        if($roleID == 21){
            $data['old_case_no'] = DB::table('r_m__case_rgisters')->select('id', 'case_no')->where('status',3)->where('upazila_id',$userUpazila)->get();
        }
        if($roleID == 5){
            ...
            $data['upazilas'] = DB::table('upazila')
                ...
                ->get();
            $data['old_case_no'] = DB::table('r_m__case_rgisters')->select('id', 'case_no')->where('status',3)->where('district_id',$userDistrict)->get();
        }
        ...
        // return $data;
        $data['page_title'] = 'নতুন ভূমি রাজস্ব মামলা রেজিষ্টার এন্ট্রি ফরম';
    ...
    public function store(Request $request)
    {
        ...
        if(isset($request->ref_case_no)>0){
            $old_case_no = DB::table('r_m__case_rgisters')->select('case_no')->where('id',$request->ref_case_no)->first()->case_no;
        }else{
            $old_case_no = NULL;
        }
        // return $old_case_no;
        ...
        /*if($request->input('file_type')){
            foreach($request->input('file_type') as $key => $val)
            {
                $request->validate([
                    'file_name.'.$key => 'required',
                    'file_type.'.$key => 'required',
                    ],
                    [
                    'file_name.'.$key => 'অন্যান্য সংযুক্তি যুক্ত করুন ',
                    'file_type.'.$key => 'অন্যান্য সংযুক্তির নাম লিখুন ',
                    ]);
            }
        }*/
        ...
        $rmcase->rm_case_ref_id = $request->ref_case_no;
        $rmcase->ref_rm_case_no = $old_case_no;
