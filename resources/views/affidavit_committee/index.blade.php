...
<div class="card card-custom">
   <div class="card-header flex-wrap py-5">
      ...
      <div class="card-toolbar">        
         <a href="{{ route('affidavit-committtee.create') }}" class="btn btn-sm btn-primary font-weight-bolder">
      ...
      <table class="table table-hover mb-6 font-size-h6">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <a href="{{ route('affidavit-committtee.show', $row->id) }}" class="btn btn-success btn-shadow btn-sm font-weight-bold pt-1 pb-1">বিস্তারিত</a>
                  <a href="{{ route('affidavit-committtee.edit', $row->id) }}" class="btn btn-success btn-shadow btn-sm font-weight-bold pt-1 pb-1">সংশোধন</a>
               </td>
            </tr>
            @empty
            <tr>
