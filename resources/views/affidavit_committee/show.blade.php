...
<div class="card card-custom col-7">
   <div class="card-header flex-wrap py-5">
      ...
      <div class="card-toolbar">
         <a href="{{ url('affidavit-committtee') }}" class="btn btn-sm btn-primary font-weight-bolder">
   ...
   <div class="card-body">
      ...
      <div class="d-flex mb-3">
         <span class="text-dark-100 flex-root font-weight-bold font-size-h6">পদবী</span>
         <span class="text-dark flex-root font-weight-bolder font-size-h6">{{ $userManagement->designation}}</span>
      </div>
      <div class="d-flex mb-3">
