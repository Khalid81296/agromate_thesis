...
<div class="row">
   <div class="card card-custom col-12">
      ...
      <form action="{{ route('affidavit-committtee.update', $userManagement->id) }}" method="POST" enctype="multipart/form-data">
         @csrf
         @method('PUT')
         <div class="card-body">
            <fieldset>
               ...
               <div class=" col-12 row">
                  ...
                  <div class="col-4">
                     <div class="form-group">
                         ...
                         <input type="text" id="designation" name="designation" placeholder="ব্যবহারকারীর নাম লিখুন" class="form-control form-control-sm" value="{{ $userManagement->designation}}">
                         <span style="color: red">
