...
<div class="row">
	<div class="col-lg-12">
		<div class="card card-custom gutter-b example example-compact">
			<form method="POST" action="{{route('advocate-management.store')}}">	
				@csrf
				<div class="card">
				    ...
				    <div class="card-body card-block row">
				        ...
				        <div class="col-4">
				            <div class="form-group">
				                ...
				                <input type="text" id="present_address" name="present_address" placeholder="ব্যবহারকারীর নাম লিখুন" class="form-control form-control-sm">
				                <span style="color: red">
				        ...
				        <div class="col-4">
				            <div class="form-group">
				                ...
				                <input type="text" id="permanent_address" name="permanent_address" placeholder="ব্যবহারকারীর নাম লিখুন" class="form-control form-control-sm">
				                <span style="color: red">
		                ...
		                <div class="col-4">
		                    <div class="form-group">
		                        ...
		                        <input type="text" name="password" id="password" placeholder="পাসওয়ার্ড লিখুন" class="form-control form-control-sm">
		                        <span style="color: red">
				      ...
				      <div class="modal-content">
				        ...
				        <div class="modal-body">
				           <table class="tg">
				                    ...
				                    <tr>
				                        <th class="tg-19u4 text-center">বর্তমান ঠিকানা </th>
				                        <td class="tg-nluh" id="previewPreAddress"></td>
				                    </tr>
				                    <tr>
				                        <th class="tg-19u4 text-center">স্থায়ী ঠিকানা </th>
				                        <td class="tg-nluh" id="previewParAddress"></td>
				                    </tr>
				                    <tr>
...
$('document').ready(function(){
	$('#preview').on('click',function(){
		...
		$('#previewPreAddress').html(present_address);
		$('#previewParAddress').html(permanent_address);
