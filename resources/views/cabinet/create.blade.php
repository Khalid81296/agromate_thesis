                ...
                <div class="card-body">
                    <fieldset class="mb-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 mb-5">
                                <label>কেস ক্যাটেগরি <span class="text-danger">*</span></label>
                                <!-- <input type="text" name="case_type" id="case_type" class="form-control form-control-sm" placeholder="মামলার ধরণ" autocomplete="off"> -->
                                <select name="case_type" id="case_type" class="form-control form-control-sm">
                                    <option value="">-- নির্বাচন করুন --</option>
                                    @foreach ($case_types as $value)
                        ...
                        <div class="col-md-6">
                            <fieldset class="mb-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <label></label>
                                        <textarea name="bisoybostu" class="form-control" id="bisoybostu" rows="3"  spellcheck="false"></textarea>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <fieldset class="mb-6">
                                <legend>গুরুত্বপূর্ণ হলে তার কারণ/যৌক্তিকতা<br> (শুধুমাত্র মন্ত্রণালয় কর্তৃক পূরন) </legend>
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <label></label>
                                        <textarea name="tafsil" class="form-control" id="tafsil" rows="3"  spellcheck="false"></textarea>
...
<script>
    ...
    <script type="text/javascript">
        ...
        function addBibadiRowFunc(){
            ...
            items+= '<td><select name="upazila[]" id="upazila_id" class="form-control form-control-sm" ><option value="">-- নির্বাচন করুন --</option>@foreach ($upazilas as $value)<option value="{{ $value->id }}" {{ old('upazila') == $value->id ? 'selected' : '' }}> {{ $value->upazila_name_bn }} </option>@endforeach</select></td>';
            items+= '<td><select name="mouja" id="mouja_id" class="form-control form-control-sm"><option value="">-- নির্বাচন করুন --</option></select></td>';
