...
<div class="card card-custom">
   <div class="card-header flex-wrap py-5">
      ...
      @if(Auth::user()->role_id == 5 OR Auth::user()->role_id == 8 OR Auth::user()->role_id == 29)
      <div class="card-toolbar">
      <a href="{{ url('case/create') }}" class="btn btn-sm btn-primary font-weight-bolder">
            <i class="la la-plus"></i>পুরাতন মোকদ্দমা এন্ট্রি
         </a>
      </div>
      @endif
   </div>
   ...
   <div class="card-body">
      ...
      <!-- <form class="form-inline" method="GET">
         ...
         <div class="form-group mb-2 mr-2">
            <input type="text" class="form-control " name="case_no" placeholder="মোকদ্দমা নং" value="">
         </div>
         <div class="form-group mb-2 mr-2">
      ...
      <table class="table table-hover mb-6 font-size-h5">
         ...
         <tbody>
            ...
            <?php
               // if($row->status == 1){
               //    $caseStatus = '<span class="label label-inline label-light-primary font-weight-bold">নতুন মোকদ্দমা</span>';
               // }
            ?>
            <tr>
