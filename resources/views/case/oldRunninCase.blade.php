...
<div class="card card-custom">
   <div class="card-header flex-wrap py-5">
      ...
      <div class="card-toolbar">
         <a href="{{ url('case/old/running/create') }}" class="btn btn-sm btn-primary font-weight-bolder">
            <i class="la la-plus"></i>চলমান মোকদ্দমা এন্ট্রি
         </a>
      </div>
      @endif
   </div>
      ...
      <table class="table table-hover mb-6 font-size-h5">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>{{ isset($row->ct_name) ? $row->ct_name : '-'}}</td>
                  ...
                  <div class="btn-group float-right">
                     ...
                     <div class="dropdown-menu">
                        ...
                        @if (Auth::user()->role_id == 28)
                           @if($row->status != 3)
                           <a class="dropdown-item" href="{{ route('action.details', $row->id) }}">বিস্তারিত  অ্যাকশন</a>
                           @endif
                        @endif
