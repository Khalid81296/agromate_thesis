        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form action="{{ url('case/save') }}" class="form" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <fieldset class="mb-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 mb-5">
                                ...
                                <input type="text" name="case_no" id="case_no" class="form-control form-control-sm" placeholder="মামলা নং " value="{{old('case_no')}}" required="required">
                            </div> 
                            
                            <div class="col-lg-4 mb-5">
                                <label>মামলা রুজুর তারিখ <span class="text-danger">*</span></label>
                                <input type="text" name="case_date" id="case_date" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/তারিখ" autocomplete="off" value="{{old('case_date')}}" >
                            </div>
                        </div>
                    </fieldset>
                    <fieldset class="mb-8">
                    ...
                    {{-- @dd($request->badi_name)
                        @php
                            if(isset($badi_name)){
                                foreach($badi_name as $row){
                        ...
                        <script type="text/javascript">
                            var items = '';
                                items+= '<tr>';
                                items+= '<td><input type="text" name="badi_name[]" class="form-control form-control-sm" placeholder="" value={{$row}} required></td>';
                    ...
                    <fieldset>
                        ...
                        <div class="col-lg-12 mb-5">
                            <label></label>
                            <textarea name="chowhaddi" class="form-control" id="chowhaddi" rows="3" spellcheck="false" value="{{old('chowhaddi')}}"></textarea>
                        </div>
                    </fieldset>
                    <br>
                    <div class="form-group row">
