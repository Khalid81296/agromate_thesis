...
<div class="card card-custom">
   ...
   <div class="row">
      <div class="col-md-7">
         @if($info->sc_receiving_date != NULL && $info->sc_receiving_date != '1970-01-01')
          <h4 class="font-weight-bolder">তারিখ সমুহ</h4>
            <table class="tg">
               <tr>
                  <th class="tg-19u4 text-left">কারণ দর্শাইবার নোটিশ প্রাপ্তির তারিখ</th>
                  <td class="tg-nluh font-size-lg font-weight-bold">{{ en2bn($info->sc_receiving_date) }}</td>
               </tr>
               @endif
               @if($info->send_date_rm_ac != NULL && $info->send_date_rm_ac != '1970-01-01')
               <tr>
               ...
               @endif
               @if($info->send_date_ac_ulo != NULL && $info->send_date_ac_ulo != '1970-01-01')
               <tr>
               ...
               @endif
               @if($info->send_date_sf_ulo_ac != NULL && $info->send_date_sf_ulo_ac != '1970-01-01')
               <tr>
               ...
               @endif
               @if($info->send_date_ans_ac_rm != NULL && $info->send_date_ans_ac_rm != '1970-01-01')
               <tr>
               ...
               @endif
               @if($info->send_date_sf_rm_adc != NULL && $info->send_date_sf_rm_adc != '1970-01-01')
               <tr>
      ...
      <div class="col-md-5">
        @if(($info->order_date != NULL && $info->order_date != '1970-01-01') || ($info->next_assign_date != NULL && $info->next_assign_date != '1970-01-01') || ($info->past_order_date != NULL && $info->past_order_date != '1970-01-01'))
          <h4 class="font-weight-bolder">আদেশের তারিখ সমুহ</h4>
            <table class="tg">
              @if($info->order_date != NULL && $info->order_date != '1970-01-01')
               <tr>
               ...
               @endif
               @if($info->next_assign_date != NULL && $info->next_assign_date != '1970-01-01')
               <tr>
               ...
               @endif
               @if($info->past_order_date != NULL && $info->past_order_date != '1970-01-01')
               <tr>
   ...
   @endif
    ...
    <fieldset>
      <legend>সংযুক্তি </legend>
       <div class="row">
          <div class="col-md-4">
             <h4 class="font-weight-bolder">আবশ্যক সংযুক্তি</h4>
             <a href="#" class="btn btn-success btn-shadow btn-block font-weight-bold font-size-h5" data-toggle="modal" data-target="#showCauseModal">
                <i class="fa fas fa-file-pdf icon-md"></i> 
                  @if($info->mandatory_file_title == 1)
                    কারণ দর্শাইবার স্ক্যান কপি
                  @elseif($info->mandatory_file_title == 2)
                    সমন জারির স্ক্যান কপি
                  @elseif($info->mandatory_file_title == 3)
                    আর্জির স্ক্যান কপি
                  @endif
             </a>
          ...
          @if (count($files) != 0)
             @foreach ($files as $file)
                <div class="col-md-4">
                   ...
                   <a href="#" class="btn btn-success btn-shadow btn-block font-weight-bold font-size-h5" data-toggle="modal" data-target="#showFileModal">
          ...
          <div class="col-md-4">
             ...
             <a href="#" class="btn btn-success btn-shadow btn-block font-weight-bold font-size-h5" data-toggle="modal" data-target="#powerOfAtornyModal">
          ...
          <div class="col-md-4">
             ...
             <a href="#" class="btn btn-success btn-shadow btn-block font-weight-bold font-size-h5" data-toggle="modal" data-target="#SfAppeal">
   ...
   <div class="row">
    @if($info->sf_report != NULL)
         <div class="col-md-4">
            ...
            <a href="#" class="btn btn-success btn-shadow btn-block font-weight-bold font-size-h5" data-toggle="modal" data-target="#sfFinalFile">
         ...
         <div class="col-md-4">
            ...
            <a href="#" class="btn btn-success btn-shadow btn-block font-weight-bold font-size-h5" data-toggle="modal" data-target="#orderFile">
