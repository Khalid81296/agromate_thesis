...
<div class="card card-custom">
   <div class="card-header flex-wrap py-5">
      ...
      <div class="card-toolbar">
         <a href="{{ url('writcase/create') }}" class="btn btn-sm btn-primary font-weight-bolder">
      ...
      <table class="table table-hover mb-6 font-size-h5">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                    <a href="{{ route('writcase.case_audit.show', $row->id)}}" class="btn btn-primary font-weight-bold btn-sm">নিরীক্ষা</a>
                </td>
