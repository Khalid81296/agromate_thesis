            ...
            <table class="tg">
               <thead>
                  ...
                  <tr>
                     ...
                     <td class="tg-nluh"><a href="{{ route('writcase.show', $data['ref_id']) }}" target="_blank">{{ $data['ref_id'] }}</a> </td>
                  </tr>
                  @endif
                  <tr>
         ...
         <thead>
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td class="tg-nluh"><a href="{{ route('writcase.sflog.details', $row->id) }}" target="_blank"> বিস্তারিত </a></td>
               </tr>
               @php $i++; @endphp
               @endforeach
            </tbody>
