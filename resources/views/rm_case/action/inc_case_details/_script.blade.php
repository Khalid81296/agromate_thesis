<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#sfCreateSubmit').click(function(e) {
            e.preventDefault();
            $.ajax({
                url: "{{ route('rmcase.action.createsf') }}",
                method: 'post',
                data: {
        ...
        $('#sfUpdateSubmit').click(function(e) {
            ...
            $.ajax({
                url: "{{ route('rmcase.action.editsf') }}",
                method: 'post',
                data: {
                    case_id: $('#hide_case_id').val(),
        ...
        $('#ajax-hearing-file-upload').submit(function(e) {
            e.preventDefault();
            $('#hearingNoticelod').addClass('spinner spinner-white spinner-right disabled');
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "{{ route('rmcase.action.file_store_hearing') }}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
        ...
        // $('#hearing_result_upload').submit(function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "{{ route('rmcase.action.hearing_result_upload') }}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
        ...
        $('#ajax-file-upload').submit(function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "{{ route('rmcase.action.file_store') }}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
        ...
        $('#ajax-caseResult-upload').submit(function(e) {
            e.preventDefault();
            $('#csResultupLod').addClass('spinner spinner-white spinner-right disabled');
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "{{ route('rmcase.action.result_update') }}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                ...
                success: function(result) {
                    if (result.errors) {
                        ...
                        $('#csResultupLod').removeClass('spinner spinner-white spinner-right disabled');
                    } else {
                        // result.sfdata
        ...
        $('#formSubmit').click(function(e) {
            ...
            $.ajax({
                url: "{{ route('rmcase.action.forward') }}",
                method: 'post',
                data: {
                    case_id: $('#hide_case_id').val(),
                    group: radioValue,
                ...
                success: function(result) {
                    // setTimeout(function (){
                        if (result.errors) {
                            ...
                            $("#formSubmit").removeClass('disabled spinner spinner-white spinner-right');
                        } else {
                            toastr.success(result.success, "Success");
                            $('.alert-danger').hide();
