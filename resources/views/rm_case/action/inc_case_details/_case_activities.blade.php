    <div class="container">
        ...
        <div id="hearing_content">
            ...
            <div id="caseHearingList">
                @include('rm_case.action.inc_case_details._single_hearing_data')
            </div>
                    ...
                    <form method="POST" action="javascript:void(0)" id="ajax-hearing-file-upload"
                                ...
                                <fieldset>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <label> শুনারির আদেশ  <span class="text-danger">*</span></label>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <button id="hearingNoticelod" type="submit" class="btn btn-primary font-weight-bold font-size-h2">
