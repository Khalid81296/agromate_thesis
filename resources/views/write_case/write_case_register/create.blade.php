...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form action="{{ url('writcase/store') }}" class="form" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <fieldset class="mb-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 mb-5">
                                ...
                                <select name="division" id="division_id" class="form-control form-control-sm">
                                    ...
                                    <option value="{{ $value->id }}" {{ old('division') == $value->id ? 'selected' : '' }}> {{ $value->division_name_en }} </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-lg-4 mb-5">
                            ...
                            <div class="col-lg-4 mb-5">
                                <label>Advocate<span class="text-danger">*</span></label>
                                <select name="advocate" id="advocate" class="form-control form-control-sm">
                                    <option value="">-- Select --</option>
                            ...
                            <div class="col-lg-4 mb-5">
                                ...
                                <select name="ref_case_no" id="ref_case_no" class="form-control form-control-sm">
                                    <option value="">-- Select --</option>
                                    @foreach ($old_case_no as $value)
                                    <option value="{{ $value->id }}" {{ old('ref_case_no') == $value->id ? 'selected' : '' }}> {{ $value->case_number }} </option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                         ...
                         <table class="tg">
                            <thead>
                                <tr>
                                    ...
                                    <th class="tg-19u4 text-center">Division </th>
                                    <th class="tg-19u4 text-center">District </th>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function ()
        {
            ...
            jQuery('select[name="division"]').on('change',function(){
                ...
                {
                  jQuery.ajax({
                    url : '{{url("/")}}/writcase/dropdownlist/getdependentdistrict/' +dataID,
                    type : "GET",
                    dataType : "json",
            ...
            jQuery('select[name="district"]').on('change',function(){
                ...
                {
                  jQuery.ajax({
                    url : '{{url("/")}}/writcase/dropdownlist/getdependentupazila/' +dataID,
                    type : "GET",
                    dataType : "json",
                    success:function(data)
                    {
        ...
        function addAdvocateRowFunc(){
            ...
            items+= '<td><select name="advocate_name[]" class="form-control form-control-sm"><?php echo $land_type_data;?></select></td>';
