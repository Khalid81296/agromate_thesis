...
<!--begin::Row-->
@include('write_case/action/inc_case_details/_send_sec')
<!--end::Row-->
            ...
            <div class="card-header card-header-tabs-line">
                <div class="card-toolbar">
                    <ul class="nav nav-tabs nav-success nav-tabs-space-lg nav-tabs-line nav-bolder nav-tabs-line-3x"
                        ...
                        @if(Auth::user()->role_id == 26 && $info->cs_id == 46)
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab_affidavit">
                                    <span class="nav-icon"><i class="fa fas fa-receipt mr-5"></i></span>
                                    <span class="nav-text font-size-h3">কমিটি</span>
                                </a>
                            </li>
                        @endif
                        <li class="nav-item">
            ...
            <div class="card-body px-0">
                <div class="tab-content pt-5">
                    ...
                    <div class="tab-pane active" id="tab_case_details" role="tabpanel">
                        @include('write_case/action/inc_case_details/_full_case')
                    </div>
                    <!--end::Tab Content-->

                    <!--begin::Tab Content-->
                    <div class="tab-pane" id="tab_sf" role="tabpanel">
                        @include('write_case/action/inc_case_details/_sf_tab')
                    </div>
                    <!--end::Tab Content-->

                    <!--begin::Tab Content-->
                    <div class="tab-pane" id="tab_sf_report" role="tabpanel">
                        @include('write_case/action/inc_case_details/_final_sf')
                    </div>
                    <!--end::Tab Content-->

                    <!--begin::Tab Content-->
                    <div class="tab-pane" id="tab_notice" role="tabpanel">
                        @include('write_case/action/inc_case_details/_case_hearing')
                    </div>
                    <!--end::Tab Content-->
                    ...
                    <div class="tab-pane" id="tab_result" role="tabpanel">
                        @include('write_case/action/inc_case_details/_case_result')
                    </div>
                    <!--end::Tab Content-->


                    <!--begin::Tab Content-->
                    <div class="tab-pane" id="tab_affidavit" role="tabpanel">
                        @include('write_case/action/inc_case_details/_committee_select')
                    </div>
                    <!--end::Tab Content-->

                    <!--begin::Tab Content-->
                    <div class="tab-pane" id="tab_history" role="tabpanel">
                        @include('write_case/action/inc_case_details/_case_history')
                    </div>
                    <!--end::Tab Content-->
                </div>
            </div>
...
@section('scripts')
   ...
   @include('write_case.action.inc_case_details._script')
@endsection
