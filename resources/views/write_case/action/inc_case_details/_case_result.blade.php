    <div class="container" id="caseResultUpdate">
        ...
        <?php if(Auth::user()->role_id == 8 || Auth::user()->role_id == 13 || Auth::user()->role_id == 14 || Auth::user()->role_id == 15 || Auth::user()->role_id == 16){ ?>
            ...
            <div class="col-md-12">
                ...
                <div class="card card-custom example example-compact">
                    ...
                    @if ($info->in_favour_govt == null)
                        <!-- <form id="ajax-caseResult-upload" action="{{ url('writcase.action.result_update') }}" class="form" method="POST" enctype="multipart/form-data"> -->
                        <form id="ajax-caseResult-upload" action="javascript:void(0)" class="form" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-lg-4">
                                       ...
                                       <div class="radio-inline">
                                        ...
                                        <input type="hidden" name="hide_division_id" id="hide_division_id" value="{{ $info->division_id }}">
                                        <input type="hidden" name="hide_district_id" id="hide_district_id" value="{{ $info->district_id }}">
                                        <input type="hidden" name="hide_upazila_id" id="hide_upazila_id" value="{{ $info->upazila_id }}">
                                    </fieldset>
                                </div>
                            </div>
