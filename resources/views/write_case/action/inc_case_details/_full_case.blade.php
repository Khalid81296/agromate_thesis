    <div class="container">
        {{-- $info->is_sf --}}<div class="row">
                ...
                <div class="row">
                    <div class="col-md-12 mb-5">
                        ...
                        <table class="tg">
                            ...
                            <tr>
                                <th class="tg-19u4">এডভোকেট</th>
                                <td class="tg-nluh">{{ $info->advocate_name }}</td>
                            </tr>
                    ...
                    @if($selected_committee_members)
                    <div class="col-md-12 mb-5">
                        <h4 class="font-weight-bolder">এফিডেভিট কমিটি মেম্বার</h4>
                        <table class="tg">
                            <thead>
                                <tr>
                                    ...
                                    <th class="tg-19u4 text-center">মোবাইল</th>
                                </tr>
                            </thead>
                            <tbody>
                                @php $k = 1; @endphp
                                @foreach ($selected_committee_members as $member)
                                    <tr>
                                        <td class="tg-nluh">{{ en2bn($k) }}.</td>
                                        <td class="tg-nluh">{{ $member->name }}</td>
                                        <td class="tg-nluh">{{ $member->designation }}</td>
                                        <td class="tg-nluh">{{ $member->mobile_no }}</td>
                                    </tr>
                                    @php $k++; @endphp
                                @endforeach
                            </tbody>
            ...
            <br>
            <h4 class="font-weight-bolder">স্বাক্ষীর বিবরণ</h4>
            <table class="tg">
               <thead>
                  <tr>
                     <th class="tg-19u4" width="10">ক্রম</th>
            ...
            @foreach ($witnesses as $witness)
                  ...
                  <tr>
                     <td class="tg-nluh">{{ en2bn($k) }}.</td>
                     <td class="tg-nluh">{{ $witness->witness_name }}</td>
                     <td class="tg-nluh">{{ $witness->witness_designation }}</td>
                     <td class="tg-nluh">{{ $witness->witness_address }}</td>
                  </tr>
             @php $k++; @endphp
            @endforeach
               </tbody>
            ...
            <br>
            <h4 class="font-weight-bolder">বিচারকের বিবরণ</h4>
            <table class="tg">
               <thead>
                  <tr>
                     <th class="tg-19u4" width="10">ক্রম</th>
            ...
            @foreach ($justices as $justice)
                  ...
                  <tr>
                     <td class="tg-nluh">{{ en2bn($k) }}.</td>
                     <td class="tg-nluh">{{ $justice->justis_name }}</td>
                     <td class="tg-nluh">{{ $justice->justis_designation }}</td>
                  </tr>
             @php $k++; @endphp
            @endforeach
               </tbody>
