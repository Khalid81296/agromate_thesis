    <div class="container">
        ...
        <div class="row" id="sf_edit_content" style="display: none;">
            <div class="col-md-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <!--begin::Form-->
                    <form action="{{ url('writcase.action.editsf') }}" class="form" method="POST"
        ...
        <div class="row" id="sf_content" style="display: none;">
            <div class="col-md-12">
                ...
                <div class="card card-custom example example-compact">
                    <!--begin::Form-->
                    <form action="{{ route('writcase.action.createsf') }}" class="form" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <!-- <div class="loadersmall"></div> -->
                        <div class="row mb-5">
            ...
            @if ($ref_case !== NULL)
                @if ($ref_case->is_sf == 0)
                    <div class="alert-text font-size-h3">পূর্বের মামলার কোন এসএফ প্রতিবেদন তৈরি করা হয়নি
                        !</div>
                @else
                    <a href="{{ route('writcase.action.pdf_sf', $info->ref_id) }}" target="_blank"
        ...
        <?php if($info->is_sf){ ?>
        <div id="sf_docs">
            <a href="{{ route('writcase.action.pdf_sf', $info->id) }}" target="_blank" class="btn btn-sm btn-success font-size-h5 float-left">
