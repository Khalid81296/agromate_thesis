         ...
         <table>
            <tr>
               ...
               <td width="30%">
                  ...
                  <!-- <img src="<?=//'https://case.gov.bd/uploads/signature/'.$row->signature?>" alt="<?=$row->name?>" height="50"> -->
                  <img src="<?='http://127.0.0.1/uploads/signature/'.$row->signature?>" alt="<?=$row->name?>" height="50">
                  <?php } ?>
