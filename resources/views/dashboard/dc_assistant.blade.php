...
<style> 
 ...
 <!-- <marquee direction="scroll" class="text-danger">This scrolling text is created with HTML Marquee element and styled with CSS properties.</marquee> -->
<!--begin::Row-->
<div class="row">
   <div class="col-md-8">
            ...
            <ul class="navi navi-border navi-hover navi-active">
               <li class="navi-item">
                  <a class="navi-link" href="#">
                     ...
                     <div class="navi-text">
                        <span class="d-block font-weight-bold h4 pt-2">নতুন মামলা রেজিষ্টার এন্ট্রি</span>
                     </div>
                     <span class="navi-label">
