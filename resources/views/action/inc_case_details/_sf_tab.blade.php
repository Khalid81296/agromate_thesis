    <div class="container">
        ...
        <?php if($info->is_sf  && $info->is_old_running != 1){ ?>
        <!--begin::Row Edit SF-->
            ...
            <div class="col-md-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <form action="{{ url('action.editsf') }}" class="form" method="POST"
                        enctype="multipart/form-data" id="sfUpdateForm">
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12 mb-5">
                                <fieldset>
                                    <legend>এস এফ প্রতিবেদনের কপি সংযুক্তি <span class="text-danger">*</span></legend>
                                    <div class="col-lg-12 mb-5">   
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <button type="submit" id="sfUpdateSubmit"
            ...
            <div class="col-md-12">
                ...
                <div class="card card-custom example example-compact">
                    ...
                    <form action="{{ route('action.createsf') }}" class="form" method="POST"
                        enctype="multipart/form-data" id="sfCreateForm">
                        @csrf
                        <!-- <div class="loadersmall"></div> -->
                        <div class="row mb-5">
                            <div class="col-md-6">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-lg-4"></div>
                                <div class="col-lg-7">
                                    <button type="submit" id="sfCreateSubmit" class="btn btn-primary font-weight-bold font-size-h2 px-5 py-3">
        ...
        <?php if($info->is_sf  && $info->is_old_running != 1){ ?>
            <div id="sf_docs">
                ...
                @if ($info->status != 3)
                    <?php if(Auth::user()->role_id == 12 || Auth::user()->role_id == 8 || Auth::user()->role_id == 9 || Auth::user()->role_id == 10 || Auth::user()->role_id == 11 || Auth::user()->role_id == 28){ ?>
            ...
            <table class="table table-striped border mt-15">
                <thead>
        ...
        <?php }elseif($info->is_old_running == 1){ ?>

            <!--begin::Notice-->
                <embed class="hide_old_finalSF" src="{{ asset('uploads/sf_files/' . $info->sf_scaned_copy) }}" type="application/pdf" width="100%"
                height="600px" />
        ...
        <?php }else{ ?>
                ...
                <!--end::Notice-->
                    ...
                    <?php if(Auth::user()->role_id == 12 || Auth::user()->role_id == 28){ ?>
